    ...
    <div class="container">
      <div class="media mx-auto">
        ...
        <div class="container py-5">
            ...
            <div class="col-md-12">
              ...
              <div class="lc-block text-center">
                <div class="pt-sans">
                  ...
                  occaecat.&nbsp;<br />FaqCollapseCenter<br />
                  <p></p>
                </div>
              </div>
              <!-- /lc-block -->
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="accordion accordion-flush" id="accordionFlushMyFAQ1">
                <div class="lc-block accordion-item mb-5">
                  <a
                    editable="inline"
                    class="fw-bold text-decoration-none text-dark h4 collapsed montserrat"
                    href="#"
                  ...
                  <div
                    ...
                    data-bs-parent="#accordionFlushMyFAQ1"
                  >
                    <div class="accordion-body pt-sans" editable="rich">
                ...
                <div class="lc-block accordion-item mb-5">
                  <a
                    editable="inline"
                    class="fw-bold text-decoration-none text-dark h4 montserrat"
                    href="#"
                    data-bs-toggle="collapse"
